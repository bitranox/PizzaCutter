...
long_description = 'create and update projects from project templates'   # will be overwritten with long_description if exists !
...
setup_kwargs['entry_points'] = {'console_scripts': ['pizzacutter = pizzacutter.pizzacutter_cli:cli_main']}
...
# setup does not support the zip_safe option under Windows and throws a warning
